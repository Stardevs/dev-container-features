...
Installs Redis CLI tools including redis-cli, and optionally redis-server for local development.
...
|-----|-----|-----|-----|
| version | Redis version to install | string | latest |
| installServer | Install redis-server for local development | boolean | false |
| installRedisTools | Install additional Redis tools (redis-benchmark, redis-check-aof, redis-check-rdb) | boolean | true |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Stardevs/dev-container-features/blob/main/src/redis-cli/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
