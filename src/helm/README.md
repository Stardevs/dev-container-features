...
Installs Helm, the package manager for Kubernetes, with optional plugins.

## Example Usage

```json
"features": {
    "ghcr.io/Stardevs/dev-container-features/helm:1": {}
}
```
...
|-----|-----|-----|-----|
| version | Helm version to install | string | latest |
| installHelmDiff | Install helm-diff plugin | boolean | false |
| installHelmSecrets | Install helm-secrets plugin | boolean | false |
| installHelmfile | Install Helmfile for declarative Helm deployments | boolean | false |
| helmfileVersion | Helmfile version (only used if installHelmfile is true) | string | latest |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Stardevs/dev-container-features/blob/main/src/helm/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
