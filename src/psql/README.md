...
Installs PostgreSQL client tools including psql, pg_dump, pg_restore, and optionally PostgreSQL server.
...
| installServer | Install PostgreSQL server for local development | boolean | false |
| installContrib | Install postgresql-contrib with additional utilities | boolean | true |
| installPgcli | Install pgcli (enhanced PostgreSQL CLI with auto-completion) | boolean | false |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Stardevs/dev-container-features/blob/main/src/psql/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
