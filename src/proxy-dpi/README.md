...
# Proxy and Deep Packet Inspection Tools (proxy-dpi)

Installs proxy and deep packet inspection tools including mitmproxy, Wireshark/tshark, and squid transparent proxy.
...
|-----|-----|-----|-----|
| installMitmproxy | Install mitmproxy for HTTP/HTTPS interception and debugging | boolean | true |
| mitmproxyVersion | mitmproxy version | string | latest |
| installTshark | Install tshark (Wireshark CLI) for packet capture and analysis | boolean | true |
| installSquid | Install Squid transparent proxy | boolean | false |
| installNgrep | Install ngrep for network grep | boolean | true |
| installTcpdump | Install tcpdump for packet capture | boolean | true |
| installSslsplit | Install SSLsplit for SSL/TLS interception | boolean | false |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Stardevs/dev-container-features/blob/main/src/proxy-dpi/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
