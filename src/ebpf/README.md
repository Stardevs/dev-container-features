...
# eBPF Development Tools (ebpf)

Installs eBPF development and tracing tools including BCC, bpftrace, libbpf, and common utilities.
...
|-----|-----|-----|-----|
| installBcc | Install BCC (BPF Compiler Collection) tools | boolean | true |
| installBpftrace | Install bpftrace high-level tracing language | boolean | true |
| installLibbpf | Install libbpf library and development headers | boolean | true |
| installBpfTool | Install bpftool for eBPF program inspection | boolean | true |
| installPerfTools | Install perf and related performance tools | boolean | true |
| installKernelHeaders | Install kernel headers (required for eBPF compilation) | boolean | true |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Stardevs/dev-container-features/blob/main/src/ebpf/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
